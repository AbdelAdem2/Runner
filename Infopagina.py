...
def main(page: Page):
    ...
    def print_input_values():
        email_input = page.controls[0].content.content.controls[5].controls[1].controls[1]
        password_input = page.controls[0].content.content.controls[7].controls[1].controls[1]
        email_value = email_input.controls[1].value
        password_value = password_input.controls[1].value
